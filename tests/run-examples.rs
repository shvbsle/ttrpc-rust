...
fn run_examples() -> Result<(), Box<dyn std::error::Error>> {
    #[cfg(feature = "rustprotobuf")]
    {
        ...
        // These examples invoke nested Cargo processes, so keep them in this
        // test and run them sequentially. Separate #[test] functions would run
        // concurrently and contend for Cargo's package and artifact locks.
        #[cfg(unix)]
        {
